...
const (
	...
	// http
	Msg_http_request  MsgType = 30
	Msg_http_response MsgType = 31
)
...
func (x *Msg) GetHreq() *HttpRequest {
	if x, ok := x.GetPayload().(*Msg_Hreq); ok {
		return x.Hreq
	}
	return nil
}

func (x *Msg) GetHrep() *HttpResponse {
	if x, ok := x.GetPayload().(*Msg_Hrep); ok {
		return x.Hrep
	}
	return nil
}
...
type Msg_Hreq struct {
	// http
	Hreq *HttpRequest `protobuf:"bytes,40,opt,name=hreq,proto3,oneof"`
}

type Msg_Hrep struct {
	Hrep *HttpResponse `protobuf:"bytes,41,opt,name=hrep,proto3,oneof"`
}
...
func (*Msg_Hreq) isMsg_Payload() {}

func (*Msg_Hrep) isMsg_Payload() {}
...
var file_msg_proto_rawDesc = []byte{
	...
	0x09, 0x76, 0x6e, 0x63, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x1a, 0x0a, 0x68, 0x74, 0x74, 0x70,
	...
	0x6e, 0x63, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x03, 0x65, 0x6e, 0x63, 0x22, 0xad, 0x08,
	...
	0x2b, 0x0a, 0x04, 0x68, 0x72, 0x65, 0x71, 0x18, 0x28, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x15, 0x2e,
	0x6e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x48, 0x00, 0x52, 0x04, 0x68, 0x72, 0x65, 0x71, 0x12, 0x2c, 0x0a, 0x04,
	0x68, 0x72, 0x65, 0x70, 0x18, 0x29, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x16, 0x2e, 0x6e, 0x65, 0x74,
	0x77, 0x6f, 0x72, 0x6b, 0x2e, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	0x73, 0x65, 0x48, 0x00, 0x52, 0x04, 0x68, 0x72, 0x65, 0x70, 0x22, 0xa5, 0x02, 0x0a, 0x04, 0x74,
	...
	0x0c, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x10, 0x1e, 0x12,
	0x11, 0x0a, 0x0d, 0x68, 0x74, 0x74, 0x70, 0x5f, 0x72, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x10, 0x1f, 0x42, 0x09, 0x0a, 0x07, 0x70, 0x61, 0x79, 0x6c, 0x6f, 0x61, 0x64, 0x42, 0x0c, 0x5a,
...
var file_msg_proto_goTypes = []interface{}{
	...
	(*HttpRequest)(nil),      // 14: network.http_request
	(*HttpResponse)(nil),     // 15: network.http_response
}
var file_msg_proto_depIdxs = []int32{
	...
	14, // 13: network.msg.hreq:type_name -> network.http_request
	15, // 14: network.msg.hrep:type_name -> network.http_response
